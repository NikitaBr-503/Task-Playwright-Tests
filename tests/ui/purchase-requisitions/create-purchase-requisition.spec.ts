...
test.describe('Purchase Requisitions tests', () => {
  ...
  test('TC-PR-001 — Verify that a created Purchase Requisition persists every submitted value @smoke', async ({
    prListPage,
    prDetailsPage,
  }) => {
  ...
  test('TC-PR-002 — Verify that an approved Purchase Requisition can be marked as completed @regression', async ({
    prListPage,
    prDetailsPage,
  }) => {
  ...
  test('TC-PR-003 — Verify that a Purchase Requisition can be canceled with a reason @regression', async ({
    prListPage,
    prDetailsPage,
  }) => {
